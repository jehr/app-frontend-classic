import { AspirantFile } from '~/interfaces/components/pages/aspirantfile.interface'
import { setProperty } from '~/plugins/helpers'

const getDefaultState = () => ({
  isAspirantFileFilter: false,
  aspirantFileFilters: {
    search: '',
    name: ''
  },
  editedAspirantFile: { ...AspirantFile }
})
